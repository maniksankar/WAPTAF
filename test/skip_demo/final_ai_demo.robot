...
Library           TestLogic_llama.py
#Library           TestLogic_1.py
Suite Setup      Initialize Database    ${CONFIG_DIR}
Suite Teardown   Disconnect Devices
Test Setup    Test Precondition
Test Teardown     Record Test Result    ${TEST_NAME}    ${TEST_STATUS}    ${TEST_MESSAGE}    ${TEST_TAGS}
...
Test Precondition
    Evaluate Testcase    ${TEST_NAME}    ${TEST_TAGS}
...
Make Client To Default State
    ...
    #Sleep    5
    #Set Client Interface State    ${clienled as dev_ap_wc_2 is not alive.t}    ${1}
    #${state}    Get Client Interface State    ${client}
    #Should Be Equal    ${state}    ${1}
...
*** Test Cases ***
TC01000: Verify Devices In Test Bed
    [Setup]    none
    [Tags]     feature        DEV_AP_WC_1        DEV_AP_WC_2
    [Template]    Connect With Devices Template
    ${dut}
    ${wlan_client_1}
    ${wlan_client_2}

TC01001: Verify WiFi Client1 Connected With SSID_1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
    Check And Connect A Client To A Secured Ssid    ${wlan_client_1}    ${ssid_1}    ${password_1}

TC01002: Verify WiFi Client2 Connected With SSID_1
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
    Check And Connect A Client To A Secured Ssid    ${wlan_client_2}    ${ssid_1}    ${password_1}

TC01003: Verify WiFi Client1 Assigned With IP address
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01004: Verify WiFi Client2 Assigned With IP address
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01005: Verify Ping To 8.8.8.8 From WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01006: Verify Ping To 8.8.8.8 From WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01007: Verify Ping To www.google.com From WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01008: Verify Ping To www.google.com From WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01009: Verify Ping From DUT To WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01010: Verify Ping From DUT To WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01011: Verify Ping From WiFi Client1 To DUT
    [Tags]     feature       DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01012: Verify Ping From WiFi Client2 To DUT
    [Tags]     feature       DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
# TC01013: Verify Ping From WiFi Client1 To Client2
#     [Tags]     feature        DEV_AP_WC_1    DEV_AP_WC_2
#     Initial Check Ap And Its 2G Radio And Wlan Client 1 And Client 2
#     ${ssid_1}    Get 2G Ssid 1
#     ${password_1}    Get Password 1
...
# TC01014: Verify Ping From WiFi Client2 To Client1
#     [Tags]     feature        DEV_AP_WC_1    DEV_AP_WC_2
#     Initial Check Ap And Its 2G Radio And Wlan Client 1 And Client 2
#     ${ssid_1}    Get 2G Ssid 1
#     ${password_1}    Get Password 1
...
TC01015: Verify Bandwidth 40MHz In 2.4GHz Radio With WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
TC01016: Verify Bandwidth 40MHz In 2.4GHz Radio With WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01017: Verify Ping From DUT To WiFi Client1 In 40MHz
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01018: Verify Ping From DUT To WiFi Client2 In 40MHz
     [Tags]     feature        DEV_AP_WC_2
     Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01019: Verify Ping To www.google.com From WiFi Client1 In 40MHz
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01020: Verify Ping To www.google.com From WiFi Client2 In 40MHz
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_1}    Get 2G Ssid 1
    ${password_1}    Get Password 1
...
TC01021: Verify SSID_2 In 2.4GHz Radio With WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
TC01022: Verify SSID_2 In 2.4GHz Radio With WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${ssid_2}    Get 2G Ssid 2
    ${password_2}    Get Password 2
...
TC01023: Verify Channel 6 In 2.4GHz Radio With WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
TC01024: Verify Channel 6 In 2.4GHz Radio With WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${channel_2}    Get Channel 6
    ${ssid_2}    Get 2G Ssid 2 
...
#--------------------------------------------------------------------
TC01025: Verify Standard 11AX BandWidth HE20 Security Open In 2.4GHz Radio
    [Tags]     feature    ap
    Initial Check Ap And Its 2G Radio    
...
TC01026: Verify Standard 11B Security Open In 2.4GHz Radio
    [Tags]     feature    ap
    Initial Check Ap And Its 2G Radio
...
###------------------------
TC01027: Verify Encryption WPA2-Personal In 2.4GHz Radio With WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
###-------------------------
TC01028: Verify Encryption WPA2-Personal In 2.4GHz Radio With WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2  
    ${encryption_1}    Get Encryption WPA2-Personal
    ${ssid_2}    Get 2G Ssid 2 
...
####------------------------------
TC01029: Verify Ping From DUT To WiFi Client1 Encryption WPA2-Personal
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${encryption_1}    Get Encryption WPA2-Personal
    ${ssid_1}    Get 2G Ssid 1 
...
TC01030: Verify Ping From DUT To WiFi Client2 Encryption WPA2-Personal
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption_1}    Get Encryption WPA2-Personal
    ${ssid_1}    Get 2G Ssid 1 
...
TC01031: Verify Ping To www.google.com From WiFi Client1 With WPA2-Personal Encryption
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${encryption_1}    Get Encryption WPA2-Personal
    ${ssid_1}    Get 2G Ssid 1 
...
TC01032: Verify Ping To www.google.com From WiFi Client2 With WPA2-Personal Encryption 
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption_1}    Get Encryption WPA2-Personal
    ${ssid_1}    Get 2G Ssid 1 
...
TC01033: Verify Standard 11AXG Bandwidth 40MHz Security WPA2_PSK In 2.4GHz Radio
    [Tags]     feature    
    Initial Check Ap And Its 2G Radio
...
TC01034: Verify Standard 11G Bandwidth 40MHz Security WPA2_PSK In 2.4GHz Radio
    [Tags]     feature    
    Initial Check Ap And Its 2G Radio
    ${standard_axg}    Get Operating Standard g   #Need to check
    ${Encryption}    Get Encryption WPA2
    ${ssid_1}    Get 2G Ssid 1 
    ${password_1}    Get Password 1
    ${bandwidth_2}    Get Bandwidth 40MHz
...
TC01035: Verify WiFi Client1 Connect to 2.4GHz SSID With Open authentication
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
TC01036: Verify WiFi Client2 Connect to 2.4GHz SSID With Open authentication
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${open_ap}    Get Encryption Security_none
    ${ssid_1}    Get 2G Ssid 1 
...
TC01037: Verify Security WPA3-Personal In 2.4GHz Radio With WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
TC01038: Verify Security WPA3-Personal In 2.4GHz Radio With WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption}    Get Encryption WPA3
    ${ssid_1}    Get 2G Ssid 1 
...
TC01039: Verify Ping From DUT To WiFi Client1 With Security WPA3-Personal
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${encryption}    Get Encryption WPA3
    ${ssid_1}    Get 2G Ssid 1 
...
TC01040: Verify Ping From DUT To WiFi Client2 With Security WPA3-Personal
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption}    Get Encryption WPA3
    ${ssid_1}    Get 2G Ssid 1 
...
TC01041: Verify Ping google.co.in From WiFi Client1 With Security WPA3-Personal
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${encryption}    Get Encryption WPA3
    ${ssid_1}    Get 2G Ssid 1 
...
TC01042: Verify Ping google.co.in From WiFi Client2 With Security WPA3-Personal
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption}    Get Encryption WPA3
    ${ssid_1}    Get 2G Ssid 1 
...
TC01043: Verify Standard 11AXG Bandwidth 40MHz Security WPA3_SAE In 2.4GHz Radio
    [Tags]     feature    
    Initial Check Ap And Its 2G Radio
    ${standard_axg}    Get Operating Standard axg
    ${ssid_1}    Get 2G Ssid 1 
...
TC01044: Verify Security WPA2+WPA3 In 2.4GHz Radio With WiFi Client1
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
...
TC01045: Verify Security WPA2+WPA3 In 2.4GHz Radio With WiFi Client2
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption}    Get Encryption security_wpa3_mixed
    ${ssid_1}    Get 2G Ssid 1 
...
# ####------ sae-mixed
TC01046: Verify Ping From DUT To WiFi Client1 With Encryption WPA2+WPA3
    [Tags]     feature        DEV_AP_WC_1
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${encryption}    Get Encryption security_wpa3_mixed
    ${ssid_1}    Get 2G Ssid 1 
...
####------ sae-mixed
TC01049: Verify Ping From DUT To WiFi Client2 With Encryption WPA2+WPA3
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption}    Get Encryption security_wpa3_mixed
    ${ssid_1}    Get 2G Ssid 1 
...
TC01050: Verify Ping google.co.in From WiFi Client1 With Encryption WPA2+WPA3
    [Tags]     feature        DEV_AP_WC_1  
    Initial Check Ap And Its 2G Radio And Wlan Client 1
    ${encryption}    Get Encryption security_wpa3_mixed
    ${ssid_1}    Get 2G Ssid 1 
...
TC01051: Verify Ping google.co.in From WiFi Client2 With Encryption WPA2+WPA3
    [Tags]     feature        DEV_AP_WC_2
    Initial Check Ap And Its 2G Radio And Wlan Client 2
    ${encryption}    Get Encryption security_wpa3_mixed
    ${ssid_1}    Get 2G Ssid 1 
...
TC01052: Verify Standard 11NG Bandwidth 40MHz Security WPA3_SAE In 2.4GHz
    [Tags]     feature    
    Initial Check Ap And Its 2G Radio
...
TC01053: Verify Country Code US
    [Tags]     feature       REG_DOMAIN
    Initial Check Ap And Its 2G Radio
    ${domain_us}    Get Region Domain US
    Set Regulatory Domain    ${dut}     ${domain_us}
    Sleep  1
    Wait Until Keyword Succeeds    30    3    Check Regulatory Domain    ${dut}    ${2g_radio_index}    ${domain_us}
    #Get Supported Channels Count    ${dut}    ${index}
    #Get Highest Supported Channel    ${dut}    ${index}    

TC01054: Verify Country Code DE
    [Tags]     feature        REG_DOMAIN    
    Initial Check Ap And Its 2G Radio
    ${domain_de}    Get Region Domain DE  
    Set Regulatory Domain    ${dut}    ${domain_de}
    Sleep  1
    Wait Until Keyword Succeeds    30    3    Check Regulatory Domain    ${dut}    ${2g_radio_index}    ${domain_de}
    #Get Supported Channels Count    ${dut}    ${index}

TC01055: Verify Reset Country Code To US
    [Tags]     feature       REG_DOMAIN    
    Initial Check Ap And Its 2G Radio
    ${domain_us}    Get Region Domain US
    Set Regulatory Domain    ${dut}     ${domain_us}
